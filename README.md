_ _Student Management with Registration System_ _
...
Open NetBeans IDE.
Click on File → Open Project, and select the project directory you just cloned.
...
Canva: For initial mockups and wireframes.
Figma: For designing and prototyping.
Lucidchart: For visualizing database schema and app flow.
